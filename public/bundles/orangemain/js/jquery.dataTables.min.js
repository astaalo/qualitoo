...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Traitement en cours ...",sLengthMenu:"Afficher _MENU_ enregistrements",sZeroRecords:"Aucun résultat trouvé",sEmptyTable:"Pas de donnée valide",
sLoadingRecords:"Chargement en cours ...",sInfo:"Afficher _START_ à _END_ sur _TOTAL_ enregistrements",sInfoEmpty:"Aucun résultat",sInfoFiltered:"(filtrés sur un total de _MAX_ enregistrements)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Recherche:",sUrl:"",oPaginate:{sFirst:"Premier",sPrevious:"Précédant",sNext:"Suivant",sLast:"Dernier"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
