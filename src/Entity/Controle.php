...
class Controle implements NotificationInterface
{
    ...
    /**
     * @var Utilisateur
     * @ORM\ManyToOne(targetEntity="Utilisateur", inversedBy="controleOfPorteur")
     * @ORM\JoinColumns({
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="structure_porteur", referencedColumnName="id", onDelete="SET NULL")
     * })
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="grille_id", referencedColumnName="id", nullable=true)
     * })
     */
    private $grille;
    ...
    /**
     * @var Utilisateur
     * @ORM\ManyToOne(targetEntity="Utilisateur", inversedBy="controleOfSuperviseur")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="superviseur", referencedColumnName="id")
     * })
     * @Assert\NotNull(message="Le nom du superviseur est obligatoire", groups={"Validation"})
     */
    private $superviseur;
     ...
     * @ORM\ManyToOne(targetEntity="Structure")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="structure_superviseur", referencedColumnName="id", onDelete="SET NULL")
     * })
     */
     ...
     * @var MethodeControle
     *
     * @ORM\ManyToOne(targetEntity="MethodeControle")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="methode_controle_id", referencedColumnName="id")
     * })
     */
    private $methodeControle;

    /**
     * @var PlanAction
     * @ORM\OneToOne(targetEntity="PlanAction", cascade={"persist", "merge"})
    ...
    /**
     * @var PlanAction
     * @ORM\OneToOne(targetEntity="PlanAction", mappedBy="controle")
     */
    private $toPlanAction;
    ...
    /**
     * @var TypeControle
     * @ORM\ManyToOne(targetEntity="TypeControle")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="type_controle_id", referencedColumnName="id")
     * })
     */
    ...
    /**
     * @var ArrayCollection
     * @ORM\ManyToMany(targetEntity="Traitement")
     * @ORM\JoinTable(name="controle_has_traitement",
     * 	joinColumns= {
    ...
    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="Quiz", mappedBy="controle")
     */
    private $quiz;

    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="Execution", mappedBy="controle", cascade={"remove"})
     */
    private $execution;

    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="NotificationControle", mappedBy="controle", cascade={"remove"})
     */
