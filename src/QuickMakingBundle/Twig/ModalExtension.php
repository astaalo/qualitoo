...
class ModalExtension extends \Twig_Extension
{
    ...
    public function getFunctions() {
        return array(
            ...
            new \Twig_SimpleFunction('formTargetSubmit', array($this, 'formTargetSubmit'), array('is_safe' => array('html'))),
        	...
        	new \Twig_SimpleFunction('loadAjax', array($this, 'loadAjax'), array('is_safe' => array('html')))
        );
    }
