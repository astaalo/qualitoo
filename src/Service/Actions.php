...
class Actions
{
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Grille $entity   
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\Cause $entity    
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\Impact $entity   
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\Famille $entity  
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\DomaineImpact $entity    
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\DomaineActivite $entity  
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\DomaineSite $entity
     * @return string
     */
    ...
    public function generateActionsForStructure($entity)
    {
        ...
        $statement->execute();
        if ($this->user->hasRole(Utilisateur::ROLE_ADMIN) || $this->user->hasRole(Utilisateur::ROLE_USER)) {
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Activite $entity     
     * @return string
     */
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Risque $entity   
     * @return string
     */
    ...
    /**
     * @param \Orange\MainBundle\Entity\Evaluation $entity   
     * @return string
     */
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Question $entity     
     * @return string
     */
    public function generateActionsForQuestion($entity)
    {
        ...
        $this->addAction("Voir les détails", "#", $this->asset('bundles/orangemain/images/icon/color_18/info.png'));
        $this->addActionByRoles(array('ROLE_ADMIN', 'ROLE_USER'), "Modifier", $this->router->generate('edition_question', array('id' => $entity->getId())), $this->asset('bundles/orangemain/images/icon/color_18/pencil.png'), true);
        return $this->getActions();
    }

    /**
     *
     * @param \Orange\MainBundle\Entity\Menace $entity   
     * @return string
     */
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Site $entity     
     * @return string
     */
     ...
     * @param \Orange\MainBundle\Entity\PlanAction $entity   
     * @return string
     */
    ...
    public function generateActionsForControle($entity)
    {
        ...
        if ($this->user->hasRole(Utilisateur::ROLE_ADMIN) || $this->user->hasRole(Utilisateur::ROLE_USER) || $this->user->hasRole(Utilisateur::ROLE_RESPONSABLE)) {
            $content .= sprintf(
    ...
    /**
     * @param \Orange\MainBundle\Entity\Equipement $entity
     * @return string
     */
    ...
    /**
     *
     * @param \Orange\MainBundle\Entity\Chargement $entity
     * @return string
     */
