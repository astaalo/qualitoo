...
class GeneralUtil {
	...
	static $special_char = array('À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î',
	...
	static $replacement_char = array('A', 'A', 'A', 'A', 'A', 'A', 'AE', 'C', 'E', 'E', 'E', 'E', 'I', 'I', 'I',
	...
	static function replaceSpecialChar($value){
		for($i = 0; $i < count ( self::$special_char ); $i ++) {
			      $value = str_replace(self::$special_char [$i] , self::$replacement_char [$i] , $value);
		}
		return $value;
	}
}
